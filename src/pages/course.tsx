...
<button
 className='course_box'
    onClick={() =>
      window.open(
        "https://www.youtube.com/watch?v=CgkZ7MvWUAA&list=LL&index=46&t=4279s",
        "_blank",
        "noopener,noreferrer"
      )
    }
...
<button
 className='course_box'
    onClick={() =>
      window.open(
        "https://youtube.com/playlist?list=PLvepBxfiuao1hO1vPOskQ1X4dbjGXF9bm&si=BTw9L6ReQyqXGLKg",
        "_blank",
        "noopener,noreferrer"
      )
    }
...
<button
 className='course_box'
    onClick={() =>
      window.open(
        "https://youtu.be/Gex-j7GlCHc?si=rdts7t99zWGq3RHH",
        "_blank",
        "noopener,noreferrer"
      )
    }
...
<button
 className='course_box'
    onClick={() =>
      window.open(
        "https://www.youtube.com/watch?v=qw--VYLpxG4&t=681s",
        "_blank",
        "noopener,noreferrer"
      )
    }
...
Free
 ...
 className='course_box'
    onClick={() =>
      window.open(
        "https://www.youtube.com/watch?v=0zwYbudzaJc",
        "_blank",
        "noopener,noreferrer"
      )
    }
